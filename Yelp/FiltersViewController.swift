...
@objc protocol FiltersViewControllerDelegate {
    optional func filtersViewController (filtersViewController: FiltersViewController , didUpdateFilters filter : [String : AnyObject], selectedStates: [Int : Bool])
}

class FiltersViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, SwitchCellDelegate {

    //let data = [("Countries", yelpCategories("name"))]
    ...
    func switchCell(switchCell: SwitchCell, didChangedValue value: Bool) {
        ...
        default: FlagDistance[indexPath.row] = value
        }
